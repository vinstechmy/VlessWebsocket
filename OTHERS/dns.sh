...
echo -e "
 [\033[1;36m 1 \033[0m] ${RB}•${N} Temporary DNS
 [\033[1;36m 2 \033[0m] ${RB}•${N} Permanent DNS
 [\033[1;36m 3 \033[0m] ${RB}•${N} Reset DNS To Default
 [\033[1;36m 4 \033[0m] ${RB}•${N} Back To Main Menu"
echo ""
